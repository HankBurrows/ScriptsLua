...
imgui.OnInitialize(function()
    ...
    icon = imgui.GetIO().Fonts:AddFontFromFileTTF(getGameDirectory() .. '/moonloader/ArmyScript/fonts/fa-solid-900.ttf', 14.0, config, iconRanges)
end)

local COLORS = {
    [0] = {back = {0.26, 0.71, 0.81, 0.70},    text = {1, 1, 1, 1}, icon = {1, 1, 1, 1}, border = {1, 0, 0, 0}},--{back = imgui.ImVec4(0.1, 0.13, 0.17, 1), text = imgui.ImVec4(1, 1, 1, 1), icon = imgui.ImVec4(1, 0, 0.3, 1), border = imgui.ImVec4(1, 0, 0.3, 1)},
    [1] = {back = {0.26, 0.81, 0.31, 0.70},    text = {1, 1, 1, 1}, icon = {1, 1, 1, 1}, border = {1, 0, 0, 0}},
    [2] = {back = {1, 0.39, 0.39, 0.70},       text = {1, 1, 1, 1}, icon = {1, 1, 1, 1}, border = {1, 0, 0, 0}},
    [3] = {back = {0.97, 0.57, 0.28, 0.70},    text = {1, 1, 1, 1}, icon = {1, 1, 1, 1}, border = {1, 0, 0, 0}},
    [4] = {back = {0, 0, 0, 0.70},             text = {1, 1, 1, 1}, icon = {1, 1, 1, 1}, border = {1, 0, 0, 0}},
}
